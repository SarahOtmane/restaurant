    ...
    return(
        <footer className='w-100 row justify-content-space-be'>
            <ul className="gauche">
                    ...
                    {isOpenMention && (
                        <div>
                            ...
                            <section className={`popup ${color}`}>
                                ...
                                <p className="row justify-content-space-be">Nom et forme juridique de l'entreprise: <span>CHATS ASSOCIES</span></p>
                                <p className="row justify-content-space-be">Numéro de téléphone : <span>03 25 46 67 12</span></p>
                                <p className="row justify-content-space-be">Adresse e-mail : <span>restaurant.felix@hotmail.com</span></p>
                                <p className="row justify-content-space-be">Numéro fiscal local : <span>FRXX 921 717 989</span></p>
                                <p className="row justify-content-space-be">Numéro d'enregistrement pour cette autorité : <span>921 717 989 RCS Troyes</span></p>
                                <p className="row justify-content-space-be">Responsable : <span>THOMAS DIJON</span></p>
                                <p className="row justify-content-space-be">Capital Social : <span>10000</span></p>

                                <button className="m-auto" name="mentions" onClick={closePopup}>Fermer</button>
                            </section>
                        </div>
                    )}
                <li name='donnee' onClick={openPopup}>Protection de données</li>
                    {isOpenDonnee && (
                        <div>
                            <div className="overlay" onClick={closePopup}></div>
                            <section className={`popup donnee ${color}`}>
                                <h2 className="w-max-c m-auto">Déclaration de protection des données</h2>
                                <h3>Traitement des données à caractère personnel et transfert à des tiers</h3>
                                <p>
                                    Lors de l'utilisation de notre site, certaines données personnelles sont collectées automatiquement sur votre appareil (ordinateur, téléphone portable, tablette, etc.). L'adresse IP actuellement utilisée par votre appareil, la date, l'heure, le navigateur, le système d'exploitation de votre appareil et les pages récupérées sont collectés. Ceci dans le but de veiller à la sécurité des données, pour optimiser notre portée et améliorer notre site Web. Le traitement de ces données personnelles est effectué en vertu de l'art. 6, paragr. 1, phrase 1, lettre f) du RGPD (Règlement général sur la protection des données). La protection de notre site Internet et l'optimisation de nos services représentent un intérêt légitime de notre part.
                                        <br/><br/>
            ...
            <article className="droite">
                ...
                <div><IoMdMailUnread className='icon' /> restaurant.felix@hotmail.com</div>
            </article>
        </footer>
    )
}
